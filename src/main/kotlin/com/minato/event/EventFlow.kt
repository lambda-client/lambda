...
import com.minato.event.EventFlow.concurrentFlow
import com.minato.event.EventFlow.concurrentListeners
import com.minato.event.EventFlow.minatoScope
import com.minato.event.EventFlow.post
import com.minato.event.EventFlow.syncListeners
...
object EventFlow {
    /**
     * [minatoScope] is a [CoroutineScope] which is used to launch coroutines.
     *
     ...
     */
    val minatoScope = CoroutineScope(Dispatchers.Default + SupervisorJob())
