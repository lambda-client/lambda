...
import com.minato.gui.dsl.ImGuiBuilder.openPopup
import com.minato.gui.dsl.ImGuiBuilder.text
import com.lambda.imgui.ImDrawList
import com.lambda.imgui.ImFont
import com.lambda.imgui.ImGui
import com.lambda.imgui.ImGui.begin
import com.lambda.imgui.ImGui.beginChild
import com.lambda.imgui.ImGui.beginCombo
import com.lambda.imgui.ImGui.beginDragDropSource
import com.lambda.imgui.ImGui.beginDragDropTarget
import com.lambda.imgui.ImGui.beginGroup
import com.lambda.imgui.ImGui.beginMainMenuBar
import com.lambda.imgui.ImGui.beginMenu
import com.lambda.imgui.ImGui.beginMenuBar
import com.lambda.imgui.ImGui.beginPopup
import com.lambda.imgui.ImGui.beginPopupContextItem
import com.lambda.imgui.ImGui.beginPopupContextVoid
import com.lambda.imgui.ImGui.beginPopupContextWindow
import com.lambda.imgui.ImGui.beginPopupModal
import com.lambda.imgui.ImGui.beginTabBar
import com.lambda.imgui.ImGui.beginTabItem
import com.lambda.imgui.ImGui.beginTooltip
import com.lambda.imgui.ImGui.calcTextSize
import com.lambda.imgui.ImGui.collapsingHeader
import com.lambda.imgui.ImGui.colorButton
import com.lambda.imgui.ImGui.colorEdit4
import com.lambda.imgui.ImGui.colorPicker4
import com.lambda.imgui.ImGui.dragFloat
import com.lambda.imgui.ImGui.dragInt
import com.lambda.imgui.ImGui.end
import com.lambda.imgui.ImGui.endChild
import com.lambda.imgui.ImGui.endCombo
import com.lambda.imgui.ImGui.endDragDropSource
import com.lambda.imgui.ImGui.endDragDropTarget
import com.lambda.imgui.ImGui.endGroup
import com.lambda.imgui.ImGui.endMainMenuBar
import com.lambda.imgui.ImGui.endMenu
import com.lambda.imgui.ImGui.endMenuBar
import com.lambda.imgui.ImGui.endPopup
import com.lambda.imgui.ImGui.endTabBar
import com.lambda.imgui.ImGui.endTabItem
import com.lambda.imgui.ImGui.endTooltip
import com.lambda.imgui.ImGui.getBackgroundDrawList
import com.lambda.imgui.ImGui.getColorU32
import com.lambda.imgui.ImGui.getContentRegionAvail
import com.lambda.imgui.ImGui.getCursorPosX
import com.lambda.imgui.ImGui.getCursorPosY
import com.lambda.imgui.ImGui.getFont
import com.lambda.imgui.ImGui.getFontSize
import com.lambda.imgui.ImGui.getForegroundDrawList
import com.lambda.imgui.ImGui.getFrameHeight
import com.lambda.imgui.ImGui.getFrameHeightWithSpacing
import com.lambda.imgui.ImGui.getIO
import com.lambda.imgui.ImGui.getItemID
import com.lambda.imgui.ImGui.getItemRectMaxX
import com.lambda.imgui.ImGui.getItemRectMaxY
import com.lambda.imgui.ImGui.getItemRectMinX
import com.lambda.imgui.ImGui.getItemRectMinY
import com.lambda.imgui.ImGui.getStyle
import com.lambda.imgui.ImGui.getVersion
import com.lambda.imgui.ImGui.getWindowContentRegionMaxX
import com.lambda.imgui.ImGui.getWindowContentRegionMaxY
import com.lambda.imgui.ImGui.getWindowDrawList
import com.lambda.imgui.ImGui.getWindowHeight
import com.lambda.imgui.ImGui.getWindowPos
import com.lambda.imgui.ImGui.getWindowPosX
import com.lambda.imgui.ImGui.getWindowPosY
import com.lambda.imgui.ImGui.getWindowSize
import com.lambda.imgui.ImGui.getWindowViewport
import com.lambda.imgui.ImGui.getWindowWidth
import com.lambda.imgui.ImGui.image
import com.lambda.imgui.ImGui.inputDouble
import com.lambda.imgui.ImGui.inputFloat
import com.lambda.imgui.ImGui.inputFloat2
import com.lambda.imgui.ImGui.inputFloat3
import com.lambda.imgui.ImGui.inputFloat4
import com.lambda.imgui.ImGui.isAnyItemActive
import com.lambda.imgui.ImGui.isAnyItemFocused
import com.lambda.imgui.ImGui.isAnyItemHovered
import com.lambda.imgui.ImGui.isItemActivated
import com.lambda.imgui.ImGui.isItemActive
import com.lambda.imgui.ImGui.isItemClicked
import com.lambda.imgui.ImGui.isItemDeactivated
import com.lambda.imgui.ImGui.isItemDeactivatedAfterEdit
import com.lambda.imgui.ImGui.isItemEdited
...
import com.lambda.imgui.ImGui.popStyleColor
import com.lambda.imgui.ImGui.popStyleVar
import com.lambda.imgui.ImGui.popTextWrapPos
import com.lambda.imgui.ImGui.pushFont
import com.lambda.imgui.ImGui.pushID
import com.lambda.imgui.ImGui.pushItemWidth
import com.lambda.imgui.ImGui.pushStyleColor
import com.lambda.imgui.ImGui.pushStyleVar
import com.lambda.imgui.ImGui.pushTextWrapPos
import com.lambda.imgui.ImGui.setClipboardText
import com.lambda.imgui.ImGui.setCursorPosX
import com.lambda.imgui.ImGui.setCursorPosY
import com.lambda.imgui.ImGui.sliderFloat
import com.lambda.imgui.ImGui.sliderInt
import com.lambda.imgui.ImGui.textColored
import com.lambda.imgui.ImGui.textUnformatted
import com.lambda.imgui.ImGui.treeNode
import com.lambda.imgui.ImGui.treePop
import com.lambda.imgui.ImGuiIO
import com.lambda.imgui.ImGuiStyle
import com.lambda.imgui.ImGuiTextFilter
...
import com.lambda.imgui.flag.ImGuiDir
...
import com.lambda.imgui.flag.ImGuiSelectableFlags
import com.lambda.imgui.flag.ImGuiTabBarFlags
import com.lambda.imgui.flag.ImGuiTreeNodeFlags
import com.lambda.imgui.flag.ImGuiWindowFlags
import com.lambda.imgui.type.ImBoolean
import com.lambda.imgui.type.ImDouble
...
object ImGuiBuilder {
     ...
     */
    @ImGuiDsl
    fun minatoTooltip(description: String) {
    ...
    @ImGuiDsl
    fun Color.toImColor() = com.lambda.imgui.ImColor.rgba(red, green, blue, alpha)

    @ImGuiDsl
    fun ImDrawList.addHudBox(
        minX: Float,
        minY: Float,
        maxX: Float,
        maxY: Float,
        ...
        border: Color? = null,
        rounding: Float = getStyle().frameRounding,
        shadow: Color? = Color(0, 0, 0, 40)
    ) {
        // shadow
        if (shadow != null) {
            val s = shadow.toImColor()
            addRectFilled(minX + 2f, minY + 2f, maxX + 2f, maxY + 2f, s, rounding)
        }

        val bgc = bg.toImColor()
        addRectFilled(minX, minY, maxX, maxY, bgc, rounding)

        if (border != null) {
            val bc = border.toImColor()
            addRect(minX, minY, maxX, maxY, bc, rounding, ImDrawListFlags.None, getStyle().frameBorderSize)
        }
    }

    @ImGuiDsl
    fun hudBackground(width: Float, height: Float, bg: Color, border: Color? = null, rounding: Float = style.frameRounding, padding: Float = style.framePadding.x, block: ProcedureBlock) {
        val minX = windowPos.x + cursorPosX
        val minY = windowPos.y + cursorPosY
        val maxX = minX + width
        val maxY = minY + height
        windowDrawList.addHudBox(minX, minY, maxX, maxY, bg, border, rounding)
        // advance cursor inside box
        cursorPosX += padding
        cursorPosY += padding
        block()
        // restore cursor x to right of box
        cursorPosX = (minX - windowPos.x) + width + padding
    }
