...
import com.minato.util.StringUtils.levenshteinDistance
...
object QuickSearch {
    ...
    init {
        listenUnsafe<ButtonEvent.Keyboard.Press> { event ->
            if (mc.currentScreen !is MinatoScreen) return@listenUnsafe
    ...
    private class CommandResult(val command: MinatoCommand) : SearchResult {
