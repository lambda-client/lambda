...
import com.minato.module.modules.player.Replay.InputAction.Companion.toAction
...
import com.minato.util.FormattingUtils.getTime
...
object Replay : Module(
    ...
    private fun save(
        ...
        minatoScope.launch(Dispatchers.IO) {
