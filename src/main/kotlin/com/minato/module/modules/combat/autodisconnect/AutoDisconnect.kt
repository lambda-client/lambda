...
package com.minato.module.modules.combat.autodisconnect
...
import com.minato.util.combat.CombatUtils.crystalDamage
...
object AutoDisconnect : Module(
    ...
    private fun SafeContext.requestDisconnect(reasonText: Text, disarmedTrigger: Reason? = null): Boolean {
        ...
        ScreenshotRecorder.takeScreenshot(Minato.mc.framebuffer, 1) { image ->
            val imageIdentifier = Identifier.of("minato", "auto_disconnect_screenshot")
