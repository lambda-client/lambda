...
import com.minato.config.blocks.LineConfig
...
import com.minato.graphics.text.SDFFontAtlas
import com.minato.graphics.texture.MinatoImageAtlas
import com.minato.graphics.util.DirectionMask
import com.minato.graphics.util.DirectionMask.hasDirection
...
class RenderBuilder(private val cameraPos: Vec3d, var depthTest: Boolean = false) {
	...
	fun screenImage(
		image: MinatoImageAtlas.ImageEntry,
		x: Float, y: Float,
	...
	fun screenImage(
		...
		val imageEntry = MinatoImageAtlas.loadMCTexture(texture) ?: return
