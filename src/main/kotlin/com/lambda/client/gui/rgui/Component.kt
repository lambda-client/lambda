...
open class Component(
    ...
    private var widthSetting = setting("Width", widthIn, 0.0f..69420.914f, 0.1f, { false }, { _, it -> it.coerceIn(minWidth, max(scaledDisplayWidth, minWidth)) })
    private var heightSetting = setting("Height", heightIn, 0.0f..69420.914f, 0.1f, { false }, { _, it -> it.coerceIn(minHeight, max(scaledDisplayHeight, minHeight)) })
