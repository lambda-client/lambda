...
open class BasicWindow(
    ...
    override fun onRender(vertexHelper: VertexHelper, absolutePos: Vec2f) {
        ...
        if(ClickGUI.outline)
        RenderUtils2D.drawRoundedRectOutline(vertexHelper, Vec2d(0.0, 0.0), Vec2f(renderWidth, renderHeight).toVec2d(), ClickGUI.radius, lineWidth = ClickGUI.outlineSize, color = GuiColors.primary)
    }
