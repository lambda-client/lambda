...
object BuildTools : Module(
    ...
    val collectRange by setting("Collect Range", 16, 1..50, 1, { page == Page.BUILDING }, description = "Sets the range of the pickup", unit = " blocks")
    val minimumStackSize by setting("Minimum Amount Collect", 32, 1..64, 1, { page == Page.BUILDING }, description = "Minimum amount of items to pick up", unit = " items")
