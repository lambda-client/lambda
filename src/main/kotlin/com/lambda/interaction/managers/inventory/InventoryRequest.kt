...
class InvRequestBuilder private constructor(
	...
	private val actions = mutableListOf<InventoryAction>()
	private var onComplete: (SafeContext.() -> Unit)? = null
	...
	fun swapWithHotbar(slotId: Int, hotbarSlot: Int) = click(slotId, hotbarSlot, SlotActionType.SWAP)
