...
@Suppress("unused")
object ClassCollectionSettingTypeAdapter : TypeAdapter<ClassCollectionSetting<*>>() {
	override val type = ClassCollectionSetting::class.java

	override val serializer = object : Serializer<ClassCollectionSetting<*>>(type) {
		override fun serialize(
			setting: ClassCollectionSetting<*>,
			gen: JsonGenerator,
	...
	override val deserializer = object : Deserializer<ClassCollectionSetting<*>>(type) {
