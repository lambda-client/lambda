...
class ScreenLineSettings(override val c: Config) : LineConfig, ConfigBlock {
	...
	@Group(DashGroup) val dashLengthSetting by c.setting("Dash Length", 30, 1..50, 1, "Length of each dash") { dashEnabled }
	override val dashLength get() = dashLengthSetting * 0.001f
	@Group(DashGroup) val gapLengthSetting by c.setting("Gap Length", 15, 1..50, 1, "Length of gaps between dashes") { dashEnabled }
