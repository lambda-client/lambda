package me.zeroeightsix.kami.module.modules.experimental.experimental;
...
@Module.Info(name = "NoSoundLag", category = Module.Category.MISC, description = "Prevents sound lag")
