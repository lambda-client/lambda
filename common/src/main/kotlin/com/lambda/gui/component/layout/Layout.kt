...
import com.lambda.graphics.pipeline.ScissorAdapter.scissor
...
open class Layout(
    ...
    private var renderActions = mutableListOf<() -> Unit>()
    ...
    fun onEvent(e: GuiEvent) {
        ...
        when (e) {
            ...
            is GuiEvent.Render -> {
                val render = { evt: GuiEvent.Render ->
                    renderActions.forEach { it() }
                    children.forEach { it.onEvent(evt) }
                }
